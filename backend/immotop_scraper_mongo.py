"""
immotop_scraper_mongo.py
========================
MongoDB-compatible version of immotop_scraper.py

This is a thin wrapper that imports immotop_scraper.py and replaces
...
# The rest of immotop_scraper.py works unchanged!
